...
public class TestTpchSubstraitConsumer {
  ...
  public void testRunQueryNamedTableTpch02() throws Exception {
    ...
    try (
        ...
        DatasetFactory datasetFactoryPartsupp = new FileSystemDatasetFactory(rootAllocator(), NativeMemoryPool.getDefault(),
  ...
  public void testRunQueryNamedTableTpch03() throws Exception {
    ...
    try (
        ...
        DatasetFactory datasetFactoryLineitem = new FileSystemDatasetFactory(rootAllocator(), NativeMemoryPool.getDefault(),
            FileFormat.PARQUET, getNamedTableUri("lineitem.parquet"));
